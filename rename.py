...
import os
path = 'E:/course/6680/ead2019_trainingData-I/ead2019_trainingData-I/train_release2_task1/image/'
...
for i in f:
    oldname = path + f[n]
    if n < 113:
        newname = path +'00000'+ str(n+1) + '.jpg'
    elif n < 99:
        newname = path +'0000'+ str(n+1) + '.jpg'
    else:
